...
/**
 * App database. Schema v8 adds canonical folder identity and asynchronous content hashes on top of durable folder-balanced shuffle queues,
 * reservations, and bounded presentation history. Every migration remains
