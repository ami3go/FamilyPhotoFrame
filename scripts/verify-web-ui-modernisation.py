...
require("img.dataset.previewRevision===revision" in js, "unchanged preview revisions are not suppressed")
require("img.dataset.loadingRevision===revision" in js, "concurrent preview fetches are not coalesced")
require("if(!document.hidden)loadPresentation()" in js, "hidden-tab preview polling is not reduced")
require("setInterval(function(){if(!document.hidden)loadPresentation()},2000)" in js, "preview polling is not 2 seconds")
